...
class Bug_Tests extends FunSuite {
  ...
  test("Given P1 at speed 6 next to P2 at speed 8 when P1 uses EMP then P2 is not hit because P2 is out of range")
  {
    initialise()
    val gameMap = TestHelper.initialiseGameWithNoMapObjects()
    val carGameMap = gameMap.asInstanceOf[CarGameMap]
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  test("Given P2 at speed 6 next to P1 at speed 8 when P2 uses EMP then P1 is not hit by EMP since P1 is out of range")
  {
    initialise()
    val gameMap = TestHelper.initialiseGameWithNoMapObjects()
    val carGameMap = gameMap.asInstanceOf[CarGameMap]
