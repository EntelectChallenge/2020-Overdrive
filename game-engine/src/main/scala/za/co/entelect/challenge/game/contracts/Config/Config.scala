...
object Config {
    ...
    def WALL_GENERATION_PERCENTAGE: Int = ConfigFileValues.OIL_ITEM_GENERATION_PERCENTAGE
    def LIZARD_GENERATION_PERCENTAGE: Int = ConfigFileValues.OIL_ITEM_GENERATION_PERCENTAGE
